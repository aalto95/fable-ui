...
| Package | Description |
| --- | --- |
| [`fable-ui`](packages/fable-ui) | Publishable library: `Renderer`, `Component`, registry, branch components, HTTP helpers, and types for pages and components. **Docs:** [README](packages/fable-ui/README.md) · **[Component reference](packages/fable-ui/COMPONENTS.md)** · **[schema.json](packages/fable-ui/schema.json)** (JSON Schema for SDUI documents). |
