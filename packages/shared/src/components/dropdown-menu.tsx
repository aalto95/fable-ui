...
function BaseDropdownMenu({ ...props }: React.ComponentProps<typeof DropdownMenuPrimitive.Root>) {
  return <DropdownMenuPrimitive.Root data-slot="dropdown-menu" {...props} />;
}

function BaseDropdownMenuPortal({
  ...props
}: React.ComponentProps<typeof DropdownMenuPrimitive.Portal>) {
  return <DropdownMenuPrimitive.Portal data-slot="dropdown-menu-portal" {...props} />;
}

function BaseDropdownMenuTrigger({
  ...props
}: React.ComponentProps<typeof DropdownMenuPrimitive.Trigger>) {
  return <DropdownMenuPrimitive.Trigger data-slot="dropdown-menu-trigger" {...props} />;
}

function BaseDropdownMenuContent({
  className,
  align = "start",
  sideOffset = 4,
  ...props
...
function BaseDropdownMenuGroup({
  ...props
...
function BaseDropdownMenuCheckboxItem({
  className,
  children,
  checked,
  inset,
...
function BaseDropdownMenuRadioGroup({
  ...props
}: React.ComponentProps<typeof DropdownMenuPrimitive.RadioGroup>) {
  return <DropdownMenuPrimitive.RadioGroup data-slot="dropdown-menu-radio-group" {...props} />;
}

function BaseDropdownMenuRadioItem({
  className,
  children,
  inset,
  ...props
...
function BaseDropdownMenuLabel({
  className,
  inset,
  ...props
...
function BaseDropdownMenuSeparator({
  className,
  ...props
...
function BaseDropdownMenuShortcut({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
...
function BaseDropdownMenuSub({ ...props }: React.ComponentProps<typeof DropdownMenuPrimitive.Sub>) {
  return <DropdownMenuPrimitive.Sub data-slot="dropdown-menu-sub" {...props} />;
}

function BaseDropdownMenuSubTrigger({
  className,
  inset,
  children,
  ...props
...
function BaseDropdownMenuSubContent({
  className,
  ...props
