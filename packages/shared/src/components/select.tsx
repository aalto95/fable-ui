...
type BaseSelectProps = Omit<React.ComponentProps<"select">, "size"> & {
  size?: "sm" | "default";
};

function BaseSelect({ className, size = "default", ...props }: BaseSelectProps) {
  return (
    <div
      className={cn(
...
function BaseSelectOption({ ...props }: React.ComponentProps<"option">) {
  return <option data-slot="native-select-option" {...props} />;
}

function BaseSelectOptGroup({ className, ...props }: React.ComponentProps<"optgroup">) {
  return <optgroup data-slot="native-select-optgroup" className={cn(className)} {...props} />;
}

export { BaseSelect, BaseSelectOptGroup, BaseSelectOption };
